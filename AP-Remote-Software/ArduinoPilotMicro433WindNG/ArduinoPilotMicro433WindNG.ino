...
const PROGMEM uint16_t ST_Track[] =    { 0x186, 0x21, 0x03, 0xFC };
const PROGMEM uint16_t ST_Disp[] =     { 0x186, 0x21, 0x04, 0xFB };
const PROGMEM uint16_t ST_PortTack[] = { 0x186, 0x21, 0x21, 0xDE }; // -1 & -10
const PROGMEM uint16_t ST_StbdTack[] = { 0x186, 0x21, 0x22, 0xDD }; // +1 & +10
const PROGMEM uint16_t ST_WindMode[] = { 0x186, 0x21, 0x23, 0xDC }; // Same as pressing Stby & Auto
